...
export const AIAnswerSchema = z.object({
  question: z
    ...
    .max(130, "Question title musn't be longer then 130 characters."),
  content: z
    .string()
    .min(100, 'Question description must have Minimum of 100 characters.'),
...
export const CreateVoteSchema = z.object({
  ...
  targetType: z.enum(
    ['question', 'answer'],
    'Invalid target type. Must be "question" or "answer".'
  ),
  voteType: z.enum(
    ['upvote', 'downvote'],
...
export const DeleteAnswerSchema = z.object({
  answerId: z.string().nonempty('Answer ID is required'),
});
...
export const ProfileSchema = z.object({
  name: z
    ...
    .max(130, "Name musn't be longer then 130 characters."),
