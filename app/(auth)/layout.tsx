...
const AuthLayout = ({ children }: { children: ReactNode }) => {
  return (
    <main className="flex justify-center items-center bg-auth-light dark:bg-auth-dark bg-cover bg-no-repeat bg-center px-4 py-10 min-h-screen">
      <section className="shadow-light100_dark100 shadow-md px-4 sm:px-8 py-10 border light-border rounded-lg min-w-full sm:min-w-[520px] background-light800_dark200">
